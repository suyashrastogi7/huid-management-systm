  ...
  return(
      <div>
          ...
          <div className='is-flex'>
              <Navbar />
              <div class="column has-background-light" style={{height : '85vh',overflowY : 'scroll'}}>
                  <div className=' has-background-white is-flex columns is-multiline is-mobile is-justify-content-space-between'>
                      ...
                      <div className={`dropdown  ${isActive ? 'is-active' : ''}`}>
                        <div className="dropdown-trigger">
                          <button className="button is-rounded" aria-haspopup="true" aria-controls="dropdown-menu" onClick={() => setIsActive(!isActive)}>
                            <span>Export</span>
                        ...
                        <div className='dropdown-menu has-text-left' id="dropdown-menu" role="menu">
                          ...
                          <button onClick={() => history.push('/stock')} className='button is-success is-rounded mx-4'><FontAwesomeIcon className='mx-2' icon={faPlus} />Add Item</button>
                      </div>
                  </div>
